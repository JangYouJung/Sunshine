...
router.get("/", function (req, res) {
  if (req.session.uid) {
    res.render("staff_studentlist");
     /*
    여기에 render("staff_studentlist", { data: context, data1: context1 }) 이런식으로 데이터 넘겨주는 쿼리 작성,
    쿼리 작성끝내면 위의 res.render("staff_studentlist");문은 지워야함
    */
